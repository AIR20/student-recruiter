...
<html>
    ...
    <?php require 'shared/navbar.php';?>
		<div class="container">
			...
			<h1 class="page-header">Book class for event</h1>
			...
			<form id ="form" action="<?php echo $app->urlFor('store_classbook_event', array('id' => $event->id)); ?>" method="post" class="form-horizontal">
